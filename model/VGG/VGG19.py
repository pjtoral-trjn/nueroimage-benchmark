...
class VGG19_3D:
    ...
    def get_model(self):
        def convolution_block(inputs, num_filters, conv_layers=2):
        ...
        # Block 3
        x = convolution_block(x, 256, 4)

        # Block 4
        x = convolution_block(x, 512, 4)
        ...
        return tf.keras.Model(images, outputs, name="3D_VGG19")
